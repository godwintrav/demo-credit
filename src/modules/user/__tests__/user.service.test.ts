...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    ...
    it('should create a new user and return user data on success', async () => {
      ...
      const response: CreateUserApiResponse =
        await userService.createUser(newMockUser);
  ...
  describe('loginUser', () => {
    it('should return an error if user does not exist', async () => {
      ...
      const response: LoginUserApiResponse = await userService.loginUser(
  ...
  describe('hashPassword', () => {
    it('should hash the password', async () => {
      ...
      const hashedPassword: string =
        await userService.hashPassword('password123');
  ...
  describe('verifyPassword', () => {
    it('should return true for correct password', async () => {
      ...
      const result: boolean = await userService.verifyPassword(
        'password123',
        'hashedPassword123',
      );
  ...
  describe('generateJWTToken', () => {
    it('should generate a JWT token', async () => {
      ...
      const token: string = await userService.generateJWTToken(
        'test@example.com',
        1,
      );
